...
This file breaks the project roadmap into a practical sequence of tasks so the project can be improved in small, testable steps.
...
### Step 24: Containerize the app
- Create Dockerfile for backend
- Create Dockerfile for frontend
- Add docker-compose for local full-stack startup

### Step 25: Add CI checks
- Run lint on each push
- Run tests in CI
- Build frontend in CI
- Fail fast on environment or type issues

### Step 26: Prepare production configs
- Add separate development and production env files
- Configure secure cookie and CORS rules for production
- Document deployment steps for hosting provider
